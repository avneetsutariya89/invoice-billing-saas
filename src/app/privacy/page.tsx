            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-blue-200">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-6 space-y-2">
                  ...
                  <li>Bill splitting calculations and history</li>
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-blue-200">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-6 space-y-2">
                  ...
                  <li>Generate accurate calculations and settlements</li>
                  <li>Store your calculation history</li>
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-blue-200">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside ml-6 space-y-2">
                  ...
                  <li>Share only aggregated analytics data</li>
